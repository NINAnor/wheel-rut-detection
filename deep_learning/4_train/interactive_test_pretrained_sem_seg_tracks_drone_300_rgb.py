...
base_data_dir = '1_training_preprosess_bash/pytorch_datasets/semantic_segmentation_drone_300_rgb'
...
# found in 20211208_interactive_test_sem_seg_tracks_drone_300_rgb.py
class_weights = torch.tensor([0.5286, 9.2334])
...
torch.save(model.state_dict(), os.path.join(
    model_save_dir,
    '20220217_last_trained_model_state_dict_9000_epochs.pth'))

torch.save(best_state_dict, os.path.join(
    model_save_dir,
    '20220217_best_iou_trained_model_state_dict_9000_epochs.pth'))

np.save(
    os.path.join(model_save_dir,
                 '20220217_loss_history_9000_epochs.npy'),
    loss_history)
np.save(
    os.path.join(
        model_save_dir,
        '20220217_lr_history_9000_epochs.npy'),
    lr_history)

np.save(
    os.path.join(
        model_save_dir,
        '20220217_confusion_matrix_history_9000_epochs.npy'),
    confusion_matrix_history)
np.save(
    os.path.join(
        model_save_dir,
        '20220217_miou_history_9000_epochs.npy'),
    miou_history)
np.save(
    os.path.join(
        model_save_dir,
        '20220217_iou_history_9000_epochs.npy'),
    iou_history)
